...
|-------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | Lagos Aguilar, Luis Eduardo<br>TB1<br>Se realizó la documentación del proyecto,incluyendo la elaboración de entrevistas para la recolección de requisitos.<br><br>TP1<br>Se elaboró el diagrama C4 para la arquitectura del sistema,definiendo los componentes y su interacción. Además, se realizaron correcciones de errores identificados en etapas anteriores del desarrollo y se creó la primera versión de la aplicación web, implementando funcionalidades clave y asegurando que se cumplieranlos requisitos iniciales.<br>TB2<br>Se elaboraron distintos artefactos en conjunto, abarcando desde el backend hasta la aplicación web, la aplicación móvil y la aplicación embebida,asegurando una integración fluida entre todos los componentes del sistema. <br> Chamorro Torres Samuel Rolando<br><br>TB1<br>Se desarrolló el Needfinding para identificar necesidades y optimizar la experiencia del usuario. También se crearon los Bounded Context Canvases para definir y contextualizar los aspectos críticos del sistema en el monitoreo.<br>TP<br>Se configuró el entorno de desarrollo y la gestión del código fuente, además de implementar la landing page y los servicios. Se completaron el Sprint 1, evidencias de pruebas y despliegue, y se documentaron las colaboraciones del equipo durante el sprint.<br>TB2<br>Se completó el Sprint 2, incluyendo planificación, backlog, desarrollo, pruebas, documentación de servicios y despliegue del software. También se realizaron entrevistas de validación y un video explicativo del producto, fortaleciendo la colaboración del equipo.<br><br>Anthony Guerrero Castillo<br>TB1<br>Se elaboró la descripción de la startup, información y análisis de los competidores, parte del Requirement Elicitation, entrevistas y partes del Solution Software Design <br>TP<br>Se implementó las validaciones para mostrar los contenedores en el Web Application<br>TB2<br>Siguiendo la herramienta Jira, se elaboró las Tasks para cada historia de usuario. Cumplí con mis tareas asignadas para los productos Web Application, API, Mobile Application y Embedded Application<br><br> Arenas Conde, José Anthony <br> <br> TB1 <br> <br> Se desarrollaron diversos puntos de manera conjunta, identificando diversos aspectos de la propuesta de software a través de reuniones presenciales que fue la principal actividad que contribuyó al desarrollo del proyecto   <br> TP1 <br> <br> Se realizaron diferentes actividades en grupo como el EventStorming, además de que se concretaron diferentes reuniones presenciales en el sprint para implementar diferentes aspectos del proyecto <br> <br> TB2 <br> <br> Para esta entrega se definieron lideres y colaboradores por aspecto dependiendo de los productos a dersarrollar favoreciendo la organización para el desarrollo del proyecto   Cancho Coila, Diego Fabian<br>TB1<br>Se realizó la definición de requirements, user stories y product backlog, tomando en cuenta las necesidades de los usuarios y las funcionalidades esperadas del sistema por parte de los mismos. <br><br>TP<br>En esta etapa, se inició con el desarrollo de nuestra solución, diseñando los productos con interfaces para los usuarios y definiendo la estructura y funcionamiento de los productos como servicios web, servidor local y aplicación embebida. <br><br>TB2<br>En esta entrega, se realizó un mayor avance del desarrollo de la solución, así como la integración con servicios externos y administrados para facilitar el proceso, tales como servicios cloud, de correo, alojamiento de aplicaciones, etc. |TB1 <br> <br> Para esta entrega se concluye que se realizaron diferentes actividades donde el liderazgo de cada integrante, dependiendo de sus puntos fuertes, fue esencial para el buen desarrollo del proyecto, como las actividades presenciales, por ejemplo el EventStorming y reuniones semanales <br> <br> TP1 <br> <br> Como grupo, concluimos que la colaboración activa y la designación de roles en el equipo permitieron la correcta implementación de las funcionalidades clave del sistema. La organización de reuniones y la participación activa de cada integrante en el desarrollo de la aplicación web y móvil facilitaron la consecución de los objetivos planteados en esta fase del proyecto. <br> <br> TB2 <br> <br> Como grupo, concluimos que se realizaron diversas actividades donde el liderazgo de cada integrante, dependiendo de sus puntos fuertes, fue esencial para el buen desarrollo del proyecto. La designación de líderes para cada producto permitió una mejor organización y ejecución de las tareas, asegurando una integración fluida entre los diferentes componentes del sistema. <br>
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. | Lagos Aguilar, Luis Eduardo<br>TB1<br>Se llevaron a cabo reuniones colaborativas para generar ideas de manera ágil y efectiva, lo que permitió avanzar con mayor seguridad en el desarrollo del proyecto.<br>TP1<br>Gracias a nuestra efectiva organización y comunicación, conseguimos finalizar la primera versión de la aplicación web de forma exitosa.<br>TB2<br>Realizamos las reuniones acordadas para monitorear el avance del proyecto, utilizando Jira para la designación de tareas, lo que facilitó la participación activa de todos los integrantes del equipo.<br> Chamorro Torres Samuel Rolando<br><br>TB1<br>Se fomentó un entorno colaborativo estableciendo metas claras y planificando tareas con el equipo para asegurar un desarrollo eficaz del sistema<br>TP<br>Se configuraron el entorno de desarrollo y la gestión del código, estableciendo guías de estilo. Se planificaron metas y tareas para el Sprint 1, y se documentaron las colaboraciones del equipo en el desarrollo y pruebas del producto.<br>TB2<br>Promovió un entorno colaborativo e inclusivo mediante la planificación de metas y tareas en el Sprint 2, logrando una ejecución coordinada y el cumplimiento de objetivos para el sistema. <br><br>Anthony Guerrero Castillo<br>TB1<br>Se realizaron reuniones para crear una misma idea entre todos los participantes, y de esta forma avanzar más rápido y seguro <br>TP<br>Gracias a nuestra buena organización logramos tener nuestra primera versión del Web Application <br>TB2<br> Pudimos realizar las reuniones acordadas para monitorear el avance del proyecto. Todos participamos activamente. <br><br> Arenas Conde, José Anthony <br> TB1 <br> <br> Se usaron herramientas que facilitaron un entorno colaborativo y comunicación constante entre los miembros del equipo, para realizar una buena solución de software <br> <br> <br> TP1 <br> <br> Se realizaron diferentes actividades en grupo y se usaron herramientas de organización como Jira <br> <br> TB2 <br> <br> Para esta entrega con la definición de los colaboradores y líderes de grupos, además del uso de Jira, se pudo mantener una buena organización para los task realizados en el Sprint 2 <br> <br><br>Cancho Coila, Diego Fabian<br><br>TB1<br>Como grupo, se procuró incentivar la participación y oportunidad de comunicar, proponer y defender ideas propias, buscando tanto un consenso en los objetivos planteados como en el desarrollo de cada uno de los integrantes como líderes capaces. <br><br>TP<br>Para la entrega parcial del trabajo, continuamos con la promoción de la participación de todos los miembros en la toma de decisiones, asegurándonos de que, durante las reuniones, contáramos con el tiempo necesario para presentar ideas sobre el proyecto y cómo aplicarlas.<br><br>TB2<br>Con esta entrega, se enfocó en la implementación de los productos, pasando de la planificación a el desarrollo. La designación de cada miembro como el líder por cada producto ayuda a centralizar criterios de desarrollo, empoderando a cada integrante del equipo y aprovechando sus capacidades y habilidades.  <br><br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | TB1 <br> <br> La planificación de metas y objetivos para el desarrollo de distintas actividades del trabajo fue esencial para poder terminar satisfactoriamente los puntos clave de este proyecto. Por ello, se planearon con anticipación dias de reuniones presenciales semanales, comunicación activa y reuniones virtuales. <br> <br> TP1 <br> <br> Como grupo, concluimos que la planificación anticipada de metas y la organización de tareas en equipo nos permitieron alcanzar los objetivos de esta entrega parcial. Las reuniones colaborativas y el uso de herramientas de gestión, como Jira, ayudaron a asegurar que todos los integrantes participaran activamente en la definición de los objetivos y en la ejecución de las tareas, promoviendo un entorno inclusivo y de constante comunicación. <br> <br> TB2 <br> <br> Como grupo, concluimos que la planificación de metas y objetivos para el desarrollo de distintas actividades fue esencial para cumplir satisfactoriamente con los puntos clave del proyecto. El uso de herramientas colaborativas como Jira y las reuniones semanales, tanto presenciales como virtuales, facilitaron un entorno inclusivo, donde se promovió la participación de todos los miembros del equipo en la toma de decisiones. <br>  |
