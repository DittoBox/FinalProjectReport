...
| **User Story** | **Work-Item / Task**                                                     |
| **Id**     | **Title**                                                                | **Id**  | **Title** | **Description**                                                    | **Estimation (points)** | **Assigned to**     | **Status**     |
| **DIT-19**   | Create a new user in the web app                                            | **DIT-475** | SignUp Interface in WebApp | Create the user interface for signing up in the web application.  | 1         | Luis Lagos         | Done    |
|            |                                                                          | **DIT-476** | Integrate backend for register a new user in WebApp | Implement backend functionality to register a new user in the web application. | 1         | Luis Lagos         | Done    |
| **DIT-22**   | Log in to an existing account in the web app                                | **DIT-477** | Login Interface in WebApp | Design and implement the login interface for users in the web app. | 1         | Luis Lagos         | Done    |
|            |                                                                          | **DIT-478** | Integrate backend for Login in WebApp | Implement the backend to authenticate users in the web app. | 1         | Luis Lagos         | Done    |
| **DIT-100**  | Change a password in the mobile app                                         | **DIT-484** | Implement password change UI in mobile app | Design and implement the UI for password change functionality in the mobile app. | 1         | Jose Arenas        | Done    |
|            |                                                                          | **DIT-503** | Change Password backend integration in mobile app | Integrate backend functionality to handle password change requests in the mobile app. | 1         | Jose Arenas        | Done    |
| **DIT-98**   | Log out of an account in the mobile app                                     | **DIT-504** | Log out in mobile app UI Design | Design the UI for logging out in the mobile app. | 1         | Jose Arenas        | Done    |
|            |                                                                          | **DIT-505** | Log out in mobile app backend integration | Implement backend functionality for logging out users in the mobile app. | 1         | Jose Arenas        | Done    |
| **DIT-94**   | Create a new user in the mobile app                                         | **DIT-349** | Create Registration Form UI | Design the registration form UI for the mobile app. | 1         | Jose Arenas        | Done    |
|            |                                                                          | **DIT-350** | Validate User Input on Registration Form | Implement user input validation for the registration form. | 1         | Diego Cancho       | Done    |
|            |                                                                          | **DIT-351** | Implement Backend Integration for User Registration | Integrate backend to handle user registration requests in the mobile app. | 1         | Diego Cancho       | Done    |
| **DIT-97**   | Log in to an existing account in the mobile app                             | **DIT-334** | Create Login Screen UI | Design the UI for the login screen in the mobile app. | 1         | Jose Arenas        | Done    |
|            |                                                                          | **DIT-335** | Implement Input Validation for Login Fields | Implement validation for login fields to ensure proper data input. | 1         | Diego Cancho       | Done    |
|            |                                                                          | **DIT-336** | Backend Integration for Login | Implement backend integration for the login process. | 1         | Diego Cancho       | Done    |
| **DIT-33**   | Grant privileges to a user in the web app                                   | **DIT-509** | Design interface to grant privileges in the web app | Design the interface for granting privileges to users. | 1         | Samuel Chamorro    | Done    |
|            |                                                                          | **DIT-510** | Implement privilege granting in the frontend in the web app | Implement the frontend functionality to grant user privileges. | 1         | Samuel Chamorro    | Done    |
|            |                                                                          | **DIT-511** | Integrate with backend to update user privileges in the web app | Integrate frontend with backend to update user privileges. | 1         | Samuel Chamorro    | Done    |
| **DIT-34**   | Revoke privileges from a user in the web app                                | **DIT-512** | Design interface to revoke privileges in the web app | Design the interface for revoking privileges from users in the web app. | 1         | Samuel Chamorro    | Done    |
|            |                                                                          | **DIT-513** | Implement privilege revocation in the frontend in the web app | Implement frontend functionality to revoke user privileges. | 1         | Samuel Chamorro    | Done    |
|            |                                                                          | **DIT-514** | Integrate with backend to update user privileges in the web app | Integrate backend functionality to update user privileges when revoked. | 1         | Samuel Chamorro    | Done    |
| **DIT-104**  | Grant privileges to a user in the mobile app                                | **DIT-357** | UI Design for Privilege Assignment Screen | Design the user interface for assigning privileges in the mobile app. | 1         | Jose Arenas        | Done    |
|            |                                                                          | **DIT-508** | Backend Integration to grant privileges to a user in mobile app | Implement backend integration to grant privileges to a user in the mobile app. | 1         | Jose Arenas        | Done    |
| **DIT-377**  | View notifications in the web app                                           | **DIT-415** | Implements static notification view | Implement static view for displaying notifications in the web app. | 1         | Luis Lagos         | Done    |
|            |                                                                          | **DIT-416** | Create filters of notifications | Implement filters for sorting and displaying notifications in the web app. | 1         | Luis Lagos         | Done    |
| **DIT-374**  | Change language in the web app                                              | **DIT-419** | Implements i18n in the web app | Implement internationalization (i18n) for language change in the web app. | 1         | Jose Arenas        | Done    |
| **DIT-41**   | View account information in the web app                                     | **DIT-388** | Implements static subscription view | Implement static view for displaying subscription details in the web app. | 1         | Luis Lagos         | Done    |
|            |                                                                          | **DIT-418** | Implements static account information view | Implement static view for displaying account information in the web app. | 1         | Luis Lagos         | Done    |
|            |                                                                          | **DIT-516** | Backend integration for account information in web app | Integrate backend to fetch account information for display in the web app. | 1         | Anthony Guerrero   | Done    |
| **DIT-116**  | Create a group in the mobile app                                            | **DIT-340** | Design Facility Creation UI | Design the user interface for creating a group (facility) in the mobile app. | 1         | Jose Arenas        | Done    |
|            |                                                                          | **DIT-341** | Implement Validation for Facility Fields | Implement input validation for creating a group in the mobile app. | 1         | Diego Cancho       | Done    |
|            |                                                                          | **DIT-342** | Backend Integration for Group/Facility Creation | Implement backend integration for creating a group in the mobile app. | 1         | Diego Cancho       | Done    |
